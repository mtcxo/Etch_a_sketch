...
function createNewSketchPad(){
    ...
    let size = prompt('Plz enter your new sketch pad dimension:\n(e.g.16=16x16, 24=24x24)\nNote:Maximum limit is 100!');
    ...
    for (let i = 1; i <= size*size;i++){ //generate new grid with user's desired grid count
